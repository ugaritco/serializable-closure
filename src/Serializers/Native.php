...
use Ugarit\SerializableClosure\Support\ClosureScope;
use Ugarit\SerializableClosure\Support\ClosureStream;
use Ugarit\SerializableClosure\Support\ReflectionClosure;
use Ugarit\SerializableClosure\Support\SelfReference;
...
class Native implements Serializable
{
     ...
     *
     * @var \Ugarit\SerializableClosure\Support\ReflectionClosure|null
     */
    protected $reflector;
     ...
     * The closure's scope.
     *
     * @var \Ugarit\SerializableClosure\Support\ClosureScope|null
     */
    protected $scope;
     ...
     */
    const ARRAY_RECURSIVE_KEY = 'UGARIT_SERIALIZABLE_RECURSIVE_KEY';
     ...
     *
     * @param  mixed  $data
     * @param  \Ugarit\SerializableClosure\Support\ClosureScope  $storage
     * @return void
     */
     ...
     *
     * @return \Ugarit\SerializableClosure\Support\ReflectionClosure
     */
